...
public class PlayerPlane extends JLabel {
	...
	public ArrayList<Attack> playerAttackList = new ArrayList<Attack>();
	Attack playerAttack;
	...
	private void playerAttackProcess() {
		for (int i = 0; i < playerAttackList.size(); i++) {
			...
			// 총알이 벽과 충돌하면 사라짐
			if (playerAttack.BulletX < 0 || playerAttack.BulletX > Map06.SCREEN_WIDTH || playerAttack.BulletY < 0
					|| playerAttack.BulletY > Map06.SCREEN_HEIGHT) {
